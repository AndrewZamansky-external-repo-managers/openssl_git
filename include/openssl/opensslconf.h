...
#undef X509_CERT_PAIR	//az. remove conflict with windows  wincrypt.h
#undef X509_EXTENSIONS  //az. remove conflict with windows  wincrypt.h
#undef X509_NAME   //az. remove conflict with windows  wincrypt.h
#undef PKCS7_SIGNER_INFO   //az. remove conflict with windows  wincrypt.h
...
//#define OPENSSL_CPUID_OBJ //az .removed
